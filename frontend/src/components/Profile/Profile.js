          ...
          <div class="col-md-8">
            <div class="card shadow mb-3">
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-sm-3">
                    <h6 class="mb-0">Purchased Amount</h6>
                  </div>
                  <div class="col-sm-9 text-secondary">
                    {purchasedAmount}
                  </div>
                ...
                <div class="row">
                  <div class="col-sm-3">
                    <h6 class="mb-0">Purchased Equity</h6>
                  </div>
                  <div class="col-sm-9 text-secondary">
                    {purchasedEquity}
                  </div>
        ...
        <div className="row">
          <div className="col-md-6 p-3 ">
            <div className="card shadow ">
              ...
              {Object.keys(equity) && Object.keys(equity).map((stock, index) => (
          ...
          <div className="col-md-6">
            <div className="card shadow container mx-auto mt-3">
              ...
              <hr/>
              {Object.keys(orders) && Object.keys(orders).map((product, index) => (
