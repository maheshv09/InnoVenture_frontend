          ...
          <div class="modal-content">
            ...
            onChange={(e) => setProductDescription(e.target.value)} required />
                ...
                <div class="form-group">
                  ...
                  <input type="file" id="productPhoto" name="productPhoto" placeholder="Photo" class="form-control" accept="image/*" onChange={(e) => setProductPhoto(e.target.files[0])} required />
                </div>
